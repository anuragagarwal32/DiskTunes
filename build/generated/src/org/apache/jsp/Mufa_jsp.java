...
public final class Mufa_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    return;\n");
      out.write("                }\n");
      out.write("                var url=\"mufaAjax.jsp?id=\"+id;\n");
      out.write("                xmlHttp.onreadystatechange= displayBal;\n");
      out.write("                xmlHttp.open(\"GET\",url,true);\n");
      out.write("                xmlHttp.send();\n");
      out.write("                \n");
      out.write("            }\n");
      out.write("            \n");
      out.write("            function displayBal()\n");
      out.write("            {   \n");
      out.write("                document.getElementById(\"cbal\").value=\"\";\n");
      out.write("                document.getElementById(\"nbal\").value=\"\";\n");
      ...
      out.write("                    {\n");
      out.write("                        document.getElementById(\"cbal\").value=\"Invalid Id\";\n");
      out.write("                        document.getElementById(\"submitButton\").disabled=true;\n");
      out.write("                    }\n");
      out.write("                    else\n");
      out.write("                    {\n");
      out.write("                        document.getElementById(\"cbal\").value= dataReceived.split(' ').join('');\n");
      ...
      out.write("        <center>\n");
      out.write("        <h1>Manage User Financial Account</h1>\n");
      out.write("        <form action=\"mufaAction.action\">    \n");
      out.write("            <!-- onkeyup for checking at every key press-->\n");
      out.write("            <table>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"fCol\">UserID</td>\n");
      out.write("                    <td><input type=\"text\" name=\"loginId\" id=\"loginId\" onchange=\"getBal(this.value);\" /></td>\n");
      out.write("                    ");
      out.write("\n");
      out.write("                </tr>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"fCol\">Current Balance</td> \n");
      out.write("                    <td><input type=\"text\" name=\"cbal\" id=\"cbal\" readonly=\"true\"/></td>\n");
      out.write("                    ");
      out.write("\n");
      out.write("                </tr>  \n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"fCol\">New Balance</td>\n");
      out.write("                    <td><input type=\"text\" name=\"nbal\" id=\"nbal\" /></td>\n");
      out.write("                    ");
      out.write("\n");
      out.write("                </tr>\n");
      out.write("            </table>\n");
      out.write("            <input type=\"submit\" value=\"Submit\" id=\"submitButton\" class=\"submitButton\" disabled=\"true\"/>\n");
      out.write("            ");
